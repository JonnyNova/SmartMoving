...
public class SmartCoreEventHandler
{
	...
	@SuppressWarnings("unused")
	public static void PlayerControllerMP_beforeOnPlayerRightClick(PlayerControllerMP playerControllerMP, EntityPlayerSP entityPlayerSP, WorldClient worldClient, ItemStack itemStack, BlockPos blockPos, EnumFacing enumFacing, Vec3 vec3)
	{
		for(SmartCoreEventHandler eventHandler : handlers)
	...
	@SuppressWarnings("unused")
	public static void PlayerControllerMP_afterOnPlayerRightClick(PlayerControllerMP playerControllerMP, EntityPlayerSP entityPlayerSP, WorldClient worldClient, ItemStack itemStack, BlockPos blockPos, EnumFacing enumFacing, Vec3 vec3)
	{
		for(SmartCoreEventHandler eventHandler : handlers)
	...
	@SuppressWarnings("unused")
	public static void ItemInWorldManager_beforeActivateBlockOrUseItem(ItemInWorldManager itemInWorldManager, EntityPlayer entityPlayer, World world, ItemStack itemStack, BlockPos blockPos, EnumFacing enumFacing, float float1, float float2, float float3)
	{
		for(SmartCoreEventHandler eventHandler : handlers)
	...
	@SuppressWarnings("unused")
	public static void ItemInWorldManager_afterActivateBlockOrUseItem(ItemInWorldManager itemInWorldManager, EntityPlayer entityPlayer, World world, ItemStack itemStack, BlockPos blockPos, EnumFacing enumFacing, float float1, float float2, float float3)
	{
		for(SmartCoreEventHandler eventHandler : handlers)
